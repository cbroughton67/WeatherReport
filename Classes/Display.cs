    ...
    public class Display
    {
        ...
        public static string CreateMenu()
        {
            ...
            do   //do until valid menu selection entered
            {
                ...
                Console.WriteLine("2) Display 15 Day Forecast");
                Console.WriteLine("3) Display Previous 15 Days' Weather");
        ...
        {
            string city;
            Console.WriteLine("Please enter a city name or postal code:");
